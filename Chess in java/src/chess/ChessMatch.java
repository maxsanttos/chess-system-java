...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePositoin, ChessPosition targePosition){
        Position source = sourcePositoin.toPosition();
    ...
    private Piece makeMove(Position source, Position target){
        ...
        if (capturPiece != null) {
            pieceOnTheBoard.remove(capturPiece);
            capturePieces.add(capturPiece);
        }
        return capturPiece;
    }
    ...
    private void undoMove(Position source, Position target,Piece capturPiece){
        ...
        if (capturPiece != null) {
            ...
            capturePieces.remove(capturPiece);
            pieceOnTheBoard.add(capturPiece);
        }
    }
